...
public class PointService {
     ...
     */
    @Transactional
    public int deduct(String ucode, int amount, String reason, String refId) {
        PointWallet wallet = pointWalletMapper.findByUcodeForUpdate(ucode);
        ...
        pointWalletMapper.updateBalance(ucode, -amount);
     ...
     */
    @Transactional
    public int add(String ucode, int amount, String reason, String refId) {
        pointWalletMapper.updateBalance(ucode, amount);
